  ...
  if (photos.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-gray-400">No photos yet. Be the first to upload!</p>
      </div>
    );
  }
      ...
      {onLoadMore && (
        <div className="mt-8 text-center">
          <button
            ...
            className="px-6 py-3 bg-white text-black rounded-full hover:bg-gray-200 disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed transition font-medium"
          >
