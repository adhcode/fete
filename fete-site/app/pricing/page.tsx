...
export const metadata: Metadata = {
  title: "Pricing - Fete",
  description: "Simple, transparent pricing for event photo sharing. Start free, upgrade as you grow.",
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-200 p-8">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">1 event</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-600">Up to 100 photos</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">Basic sharing</span>
              </li>
            </ul>
            <Link
              href="https://app.fete.com"
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-600 p-8 relative">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">Up to 1,000 photos/event</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-600">Photo approval workflow</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <Link
              href="https://app.fete.com"
              className="block w-full text-center bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition"
            >
              Start Free Trial
            </Link>
          </div>
